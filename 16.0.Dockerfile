...
ARG WKHTMLTOPDF_DISTRIBUTION=buster
...
RUN apt-get -qq update \
    ...
    # wkhtmltopdf
    && curl -SLo wkhtmltox.deb https://github.com/wkhtmltopdf/wkhtmltopdf/releases/download/${WKHTMLTOPDF_VERSION}/wkhtmltox_${WKHTMLTOPDF_VERSION}-1.${WKHTMLTOPDF_DISTRIBUTION}_amd64.deb \
